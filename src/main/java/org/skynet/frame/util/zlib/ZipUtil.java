package org.skynet.frame.util.zlib;
...
public class ZipUtil {
	...
	public static synchronized void unzipOrTar(String fileName, String extPlace)
			throws Exception {
		if (!fileName.toLowerCase().endsWith(".rar")) {
			untar(fileName, extPlace);
		}else{
			unzip(fileName, extPlace);
		}
	}
