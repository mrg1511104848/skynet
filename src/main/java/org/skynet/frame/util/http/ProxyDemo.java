...
//        //System.out.println(getHtml("www.baidu.com"));;
    }
    public static String getHtml(String targetUrl,Map<String, String> headers){
        ...
        // 代理隧道验证信息
        String proxyUser  = "H494SMWC1435G0DD";
        String proxyPass  = "E0041DA8AF011E20";
